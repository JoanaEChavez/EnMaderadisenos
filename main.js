...
div.classList.add('producto')
div.innerHTML = `
<div id="${productos.codigo}"  class="card") style="width: 16rem;">
<div class="card-img-top img-fluid">
<img src="${productos.imagen}" class="card-img-top" alt="...">
<div class="card-body">
        <h5 class="card-title">${productos.nombre}</h5>
        <p class="card-title" "precioProducto> Precio  ${productos.precio}</p>            
        <button id="agregar${productos.codigo}" class="btn btn-primary" id="botonAgregar">Agregar al carrito</button>
</div>`
